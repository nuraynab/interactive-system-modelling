...
title = tk.Label(master=header, text="Version Description", font=("Helvetica", 26), padx=20, pady=15, bg="white")
title.place(x=0, y=0)

label_1 = tk.Label(text="Version Long Description", font=("Helvetica", 20), padx=20, pady=15, bg="white")
