...
class Ui_EditItemReprInExpWindow(object):
    def setupUi(self, EditItemReprInExpWindow):
        ...
        sizePolicy.setHeightForWidth(EditItemReprInExpWindow.sizePolicy().hasHeightForWidth())
        EditItemReprInExpWindow.setSizePolicy(sizePolicy)
        self.centralwidget = QtWidgets.QWidget(EditItemReprInExpWindow)
        ...
        self.for_lineEdit.setGeometry(QtCore.QRect(200, 420, 311, 41))
        self.for_lineEdit.setObjectName("for_lineEdit")
        self.in_lineEdit = QtWidgets.QLineEdit(self.centralwidget)
        self.in_lineEdit.setGeometry(QtCore.QRect(200, 470, 311, 41))
        ...
        self.label_9.setGeometry(QtCore.QRect(20, 470, 201, 31))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        EditItemReprInExpWindow.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(EditItemReprInExpWindow)
        ...
        EditItemReprInExpWindow.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(EditItemReprInExpWindow)
        self.statusbar.setObjectName("statusbar")
        EditItemReprInExpWindow.setStatusBar(self.statusbar)
        self.menubar.addAction(self.menuInteractive_System_Modelling.menuAction())

        self.retranslateUi(EditItemReprInExpWindow)
        QtCore.QMetaObject.connectSlotsByName(EditItemReprInExpWindow)
        ...
        self.saveBtn.clicked.connect(EditItemReprInExpWindow.close)
    ...
    def retranslateUi(self, EditItemReprInExpWindow):
        _translate = QtCore.QCoreApplication.translate
        EditItemReprInExpWindow.setWindowTitle(_translate("EditItemReprInExpWindow", "MainWindow"))
        self.label.setText(_translate("EditItemReprInExpWindow", "<html><head/><body><p><span style=\" font-size:28pt;\">Edit</span></p></body></html>"))
        self.label_2.setText(_translate("EditItemReprInExpWindow", "Current fact representation"))
        self.label_3.setText(_translate("EditItemReprInExpWindow", "Animals - Animal can breath - 1 sec"))
        self.editBtn.setText(_translate("EditItemReprInExpWindow", "Edit"))
        self.label_8.setText(_translate("EditItemReprInExpWindow", "Persistence time"))
        self.label_9.setText(_translate("EditItemReprInExpWindow", "Future time"))
        self.saveBtn.setText(_translate("EditItemReprInExpWindow", "Save"))
        self.label_4.setText(_translate("EditItemReprInExpWindow", "Domain"))
