...
class Ui_AddToDatabaseWindow(object):
    def setupUi(self, AddToDatabaseWindow):
        ...
        AddToDatabaseWindow.resize(513, 534)
        ...
        self.label_6.setGeometry(QtCore.QRect(20, 350, 121, 31))
        font = QtGui.QFont()
        font.setPointSize(14)
    ...
    def createQuestion(self):
        self.CatComboBox.setGeometry(QtCore.QRect(180, 300, 311, 41))
        self.TypesComboBox.setGeometry(QtCore.QRect(180, 250, 311, 41))
        self.CatComboBox.show()
        self.TypesComboBox.show()
        self.AttrComboBox.show()
        self.label_4.show()
    ...
    def retranslateUi(self, AddToDatabaseWindow):
        ...
        self.label_4.setText(_translate("AddToDatabaseWindow", "Category"))
        self.label_5.setText(_translate("AddToDatabaseWindow", "Type"))
        self.label_6.setText(_translate("AddToDatabaseWindow", "Attribute"))
        self.label_7.setText(_translate("AddToDatabaseWindow", "Fact"))
