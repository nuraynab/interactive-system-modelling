...
class Ui_EnvironmentWindow(object):
    def setupUi(self, EnvironmentWindow):
        EnvironmentWindow.setObjectName("EnvironmentWindow")
        EnvironmentWindow.resize(1159, 861)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(EnvironmentWindow.sizePolicy().hasHeightForWidth())
        EnvironmentWindow.setSizePolicy(sizePolicy)
        self.centralwidget = QtWidgets.QWidget(EnvironmentWindow)
        ...
        self.label_5.raise_()
        EnvironmentWindow.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(EnvironmentWindow)
        ...
        EnvironmentWindow.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(EnvironmentWindow)
        self.statusbar.setObjectName("statusbar")
        EnvironmentWindow.setStatusBar(self.statusbar)
        self.menubar.addAction(self.menuInteractive_System_Modelling.menuAction())

        self.retranslateUi(EnvironmentWindow)
        QtCore.QMetaObject.connectSlotsByName(EnvironmentWindow)
    ...
    def retranslateUi(self, EnvironmentWindow):
        ...
        self.label.setText(_translate("EnvironmentWindow", "<html><head/><body><p><span style=\" font-size:28pt;\">Environment</span></p></body></html>"))
        self.label_4.setText(_translate("EnvironmentWindow", "<html><head/><body><p><span style=\" font-size:20pt;\">Facts</span></p></body></html>"))
        ...
        item.setText(_translate("EnvironmentWindow", "2"))
        item = self.factsTableWidget.verticalHeaderItem(2)
        item.setText(_translate("EnvironmentWindow", "3"))
        item = self.factsTableWidget.horizontalHeaderItem(0)
        item.setText(_translate("EnvironmentWindow", "Domain"))
        item = self.factsTableWidget.horizontalHeaderItem(1)
        item.setText(_translate("EnvironmentWindow", "Fact"))
        item = self.factsTableWidget.horizontalHeaderItem(2)
        item.setText(_translate("EnvironmentWindow", "Show for (sec)"))
        ...
        self.label_2.setText(_translate("EnvironmentWindow", "<html><head/><body><p><span style=\" font-size:14pt;\">Project: Animal-Dog</span></p></body></html>"))
        self.label_3.setText(_translate("EnvironmentWindow", "<html><head/><body><p><span style=\" font-size:14pt;\">Version #1.1: New</span></p></body></html>"))
        ...
        item.setText(_translate("EnvironmentWindow", "Question"))
        ...
        self.label_5.setText(_translate("EnvironmentWindow", "<html><head/><body><p><span style=\" font-size:20pt;\">Questions</span></p></body></html>"))
        self.menuInteractive_System_Modelling.setTitle(_translate("EnvironmentWindow", "1"))
