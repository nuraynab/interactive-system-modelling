...
title = tk.Label(master=header, text="Delete Version", font=("Helvetica", 26), padx=20, pady=15, bg="white")
title.place(x=0, y=0)

label_1 = tk.Label(text="Are you sure you want to delete this version?", font=("Helvetica", 20), padx=20, pady=15, bg="white")
